    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white dark:bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-white/10">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-3">
          ...
          <button className="w-full py-3 bg-gradient-to-b from-gold-300 via-gold-500 to-gold-700 hover:from-gold-200 hover:via-gold-400 hover:to-gold-600 text-white font-bold rounded-xl transition-all shadow-lg shadow-gold-500/40 border-t border-gold-300 flex items-center justify-center gap-2 shine-btn">
